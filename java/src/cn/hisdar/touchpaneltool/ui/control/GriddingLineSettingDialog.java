...
public class GriddingLineSettingDialog extends JDialog implements ActionListener,
																KeyListener {
	...
	private GriddingLineSettingDialog() {
		setTitle("设置网格线");
		setSize(200, 150);
		...
		JLabel widthLabel = new JLabel("横：");
		JLabel heightLabel = new JLabel("竖：");
	...
	public Dimension getGriddingLineSize() {
		return resolutionDimension;
	}
	
	public static GriddingLineSettingDialog showResolutionSettingDialog() {
		GriddingLineSettingDialog resolutionSettingDialog = new GriddingLineSettingDialog();
